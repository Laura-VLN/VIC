<template>
    <div class="container">
        <form v-bind:action="/young/+youngid" method="post" class="row mx-2 my-5 text-left">
            ...
            <textarea name="description" id="description" cols="30" rows="10" class="col-9 my-2" required></textarea><br>
            <div class="col-3 my-2" maboy="true"></div>
            <input type="hidden" name="_token" :value="csrf">
            <input class="col-9 btn btn-success my-2" type="submit" value="Enregistrer">
        </form>
    </div>
</template>
